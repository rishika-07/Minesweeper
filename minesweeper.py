...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        neighbors = set()
        # Loop through neighbors (3x3 grid around cell)
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
                if (i, j) == cell:
                    continue
        ...
        # 4 & 5. Infer new information
        # We wrap this in a loop because one discovery can trigger another
        knowledge_changed = True
        while knowledge_changed:
            knowledge_changed = False

            # Check for new known safes or mines
            for sentence in self.knowledge:
            ...
            # Subset Inference: if set1 is subset of set2, then set2 - set1 = count2 - count1
    ...
    def make_safe_move(self):
        ...
        """
        # Return any cell in self.safes that hasn't been played
